...
/**
 * This file keeps track of upgrades to the coding module
 *
...
/**
 * Execute coding upgrade from the given old version
 *
 * @param int $oldversion
 * @return bool
 */
function xmldb_coding_upgrade($oldversion) {
    global $DB;
     ...
     * for demonstrative purposes and to show how the coding
     * iself has been upgraded.
     *
     * For each upgrade block, the file coding/version.php
    ...
    if ($oldversion < 2007040100) {
        ...
        // Define field course to be added to coding.
        ...
        // Define field intro to be added to coding.
        $table = new xmldb_table('coding');
        ...
        // Define field introformat to be added to coding.
        $table = new xmldb_table('coding');
        ...
        upgrade_mod_savepoint(true, 2007040100, 'coding');
    }
    ...
    if ($oldversion < 2007040101) {
        ...
        // Define field timecreated to be added to coding.
        $table = new xmldb_table('coding');
        ...
        // Define field timemodified to be added to coding.
        $table = new xmldb_table('coding');
        ...
        // Define index course (not unique) to be added to coding.
        $table = new xmldb_table('coding');
        ...
        upgrade_mod_savepoint(true, 2007040101, 'coding');
    }
    ...
    if ($oldversion < 2007040200) {
        ...
        upgrade_mod_savepoint(true, 2007040200, 'coding');
    }

    if($oldversion < 2007040203) {
         // Define table coding to be created.
         $table = new xmldb_table('coding');

         // Adding fields to table coding.
         ...
         // Adding indexes to table coding.
         $table->add_index('course', XMLDB_INDEX_NOTUNIQUE, array('course'));
 
         // Conditionally launch create table for coding.
